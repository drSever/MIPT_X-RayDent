...
def evaluate_model(
    ...
    cfg.MODEL.SWIN.PRETRAINED = False  # при inference не нужно грузить pretrained — грузим чекпоинт
...
if __name__ == "__main__":
    ...
    results = evaluate_model(
        ...
        score_threshold=0.5,
        dataset_name="test",
        swin_model_name="swin_base_patch4_window7_224",  # должно совпадать с обучением
    )
