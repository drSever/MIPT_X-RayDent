...
- Значения метрик:
  ...
  - Dice: 0.9209
  - IoU: 0.8560
  - Precision (micro/macro): 0.9827/0.9826
  - Recall (micro/macro): 0.9900/0.9900
- Графики Loss и мерик:
![](images/losses.png)
![](images/validation_metrics.png)


## Выводы
- Отсутствие признаков переобучения, кроме RPN Classification Loss, однако метрики растут.
- Обобщающая способность модели недостаточная - на новых снимках неточно классифицируются зубы, 21 иногда оказывается внизу, а 31 вверху.
- Объем датасета недостаточен для обучения.
