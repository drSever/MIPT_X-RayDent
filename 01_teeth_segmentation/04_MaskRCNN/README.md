...
- Достичь улучшения метрик по сравнению с базовой U‑Net (Dice > 0.92 (без учета фона)), при сохранении или повышении устойчивости к новым данным.
