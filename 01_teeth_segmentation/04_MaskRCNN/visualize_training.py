...
class TrainingVisualizer:
    ...
    def plot_losses(self, save_path=None, figsize=(15, 10), show=True):
        ...
        # Total Loss
        axes[0, 0].plot(iterations, self.history['total_loss'], 'b-', linewidth=2)
        ...
        # Classification Loss
        axes[0, 1].plot(iterations, self.history['loss_cls'], 'r-', linewidth=2)
        ...
        # Box Regression Loss
        axes[0, 2].plot(iterations, self.history['loss_box_reg'], 'g-', linewidth=2)
        axes[0, 2].set_title('Box Regression Loss')
        axes[0, 2].set_xlabel('Iteration')
        axes[0, 2].set_ylabel('Loss')
        axes[0, 2].grid(True, alpha=0.3)
        
        # Mask Loss
        axes[1, 0].plot(iterations, self.history['loss_mask'], 'm-', linewidth=2)
        ...
        axes[1, 1].plot(iterations, self.history['loss_rpn_cls'], 'c-', linewidth=2)
        axes[1, 1].set_title('RPN Classification Loss')
        axes[1, 1].set_xlabel('Iteration')
        axes[1, 1].set_ylabel('Loss')
        axes[1, 1].grid(True, alpha=0.3)
        
        # RPN Localization Loss
        axes[1, 2].plot(iterations, self.history['loss_rpn_loc'], 'y-', linewidth=2)
        axes[1, 2].set_title('RPN Localization Loss')
