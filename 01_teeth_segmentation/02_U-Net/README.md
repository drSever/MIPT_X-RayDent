...
- достичь следующих значений метрик на отложенной тестовой выборке: Dice ≥ 0.90 (без учета фона), mAP50 ≥0.95; 
...
- достижение значений метрик на отложенной тестовой выборке: Global Dice ≥ 0.90 (без учета фона), mAP50≥0.95;
